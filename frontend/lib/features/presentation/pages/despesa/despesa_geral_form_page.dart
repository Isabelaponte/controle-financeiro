...
class DespesaGeralFormPage extends StatefulWidget {
  final TransacaoModel? despesa;

  const DespesaGeralFormPage({super.key, this.despesa});

  @override
  State<DespesaGeralFormPage> createState() => _DespesaGeralFormPageState();
}

class _DespesaGeralFormPageState extends State<DespesaGeralFormPage> {
  ...
  void _preencherCampos() {
    ...
    _dataVencimento = despesa.data;
    _formaPagamento = despesa.formaPagamento ?? FormaPagamento.pix;
    _fixa = despesa.fixa ?? false;
    _repete = despesa.repete ?? false;
    _pago = despesa.pago;
    _periodoController.text = despesa.periodo?.toString() ?? '';
    _contaId = despesa.contaId;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SwitchListTile(
                        ...
                        subtitle: const Text('Marcar a despesa como pago'),
                        activeThumbColor: AppColors.purpleDark,
                      ),
                    ],
                  ),
  ...
  Future<void> _salvar() async {
    ...
    try {
      ...
      bool sucesso;
      if (isEdicao) {
        sucesso = await transacaoProvider.atualizarDespesaGeral(
          widget.despesa!.id,
